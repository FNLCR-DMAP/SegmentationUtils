...
class TestCreateSplitAnnotations(unittest.TestCase):
    def test_split_sizes(self):
        ...
        expected_train_ann = {"images": [{"file_name": "test_1.png", "height": 200, "width": 200, "id": 0}, {"file_name": "test_2.png", "height": 200, "width": 200, "id": 1}], "annotations": [{"id": 0, "image_id": 0, "category_id": 1, "segmentation": [[25, 25, 26, 26, 25, 26]], "area": 3, "bbox": [26.0, 26.0, 1.0, 1.0], "iscrowd": 0}, {"id": 1, "image_id": 0, "category_id": 1, "segmentation": [[100, 100, 101, 101, 100, 101]], "area": 3, "bbox": [101, 101, 1, 1], "iscrowd": 0}, {"id": 2, "image_id": 1, "category_id": 1, "segmentation": [[50, 50]], "area": 1, "bbox": [50, 50, 1, 1], "iscrowd": 0}], "categories": [{"id": 1, "name": "Category_1", "supercategory": "Super"}]}
