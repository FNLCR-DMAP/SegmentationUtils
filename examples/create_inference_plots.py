...
output_path = "../../output_analysis"                                       # The output folder
data_path = "../data/full_data"                                             # Folder where the image data are located
gt_annotations = "../data/annotations/validation_annotations.json"          # File containing the GT annotations
inf_annotations = "../../data/inference/coco_instances_results.json"        # File containing the inference annotations
